...
// in simulator we redefine to format for practice Developer console
...
{\
	NSString * exceptionName = [@"org.practice." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.practice";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpracticeNativeItemNone = -1, 
	UIpracticeNativeItemSpinner = -2,
	UIpracticeNativeItemProgressBar = -3,
	
	UIpracticeNativeItemSlider = -4,
	UIpracticeNativeItemSwitch = -5,
	UIpracticeNativeItemMultiButton = -6,
	UIpracticeNativeItemSegmented = -7,
	
	UIpracticeNativeItemTextView = -8,
	UIpracticeNativeItemTextField = -9,
	UIpracticeNativeItemSearchBar = -10,
	
	UIpracticeNativeItemPicker = -11,
	UIpracticeNativeItemDatePicker = -12,
	
	UIpracticeNativeItemInfoLight = -13,
	UIpracticeNativeItemInfoDark = -14,
	
	UIpracticeNativeItemDisclosure = -15,
	
	UIpracticeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all practice instances of
