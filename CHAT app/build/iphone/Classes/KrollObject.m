...
//@interface practiceObject : NSObject
//@end

@interface practiceObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[practiceObject class]])
		{
			for (NSString *key in [[(practiceObject*)o modules] allKeys])
			{
